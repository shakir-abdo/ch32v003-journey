  ...
  app: {
    ...
    head: {
      ...
      meta: [
        ...
        {property: 'og:image:width', content: '2502'},
        {property: 'og:image:height', content: '1438'},
        {property: 'og:image:alt', content: 'CH32V003 Journey — Arabic bare-metal RISC-V curriculum'},
